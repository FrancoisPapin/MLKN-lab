...
if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
    nodesUrl = './data/MLKN_full_hierarchy.json';
    edgesUrl = './data/MLKN_full_hierarchy.json';
} else {
    nodesUrl = '/MLKN-lab/knowledge_network/data/MLKN_full_hierarchy.json';
    edgesUrl = '/MLKN-lab/knowledge_network/data/MLKN_full_hierarchy.json';
}
