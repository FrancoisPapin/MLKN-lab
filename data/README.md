...
All datasets for MLKN.lab are available below. Most files are stored in this repository using **Git LFS**, while the largest file is hosted on **Zenodo** for reliability.
 ...
 | `full_hierarchy_nodes.json` | 8.5MB | [GitHub](data/knowledge_network/datasets/full_hierarchy_nodes.json) | Git LFS |
 | `full_hierarchy_edges.json` | 36.8MB | [GitHub](data/knowledge_network/datasets/full_hierarchy_edges.json) | Git LFS |
 | `full_hierarchy.json` | 45.3MB | [GitHub](data/knowledge_network/datasets/full_hierarchy.json) | Git LFS |
